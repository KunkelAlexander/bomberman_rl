...
3 a). **Pretrain the agent** (single dataset):
...
3 b). **Train the agent**
```bash
python3 main.py play --agents cnn_allstar_duel rule_based_agent peaceful_agent tq_representator --train 1 --n-rounds 100000 --no-gui
```
